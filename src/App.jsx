  ...
  return (
      ...
      <div style={{backgroundColor:color}} className={'h-screen flex flex-col justify-center items-center transition-colors duration-500' }>
        ...
        <div className="flex space-x-4">
          <button className="px-4 py-2 bg-blue-400 text-white rounded hover:scale-110 transform transition-transform" type="button" onClick={() => setColor("blue")}>Blue</button>
